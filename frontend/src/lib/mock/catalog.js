// ---------------------------------------------------------------------------
// The shared course catalog — stand-in for the `courses` collection after the
// Canvas pipeline has run. Onboarding picks from this rather than from a
// hardcoded list of names, so a selected course carries its real code and
// meeting_times straight through into the plan.
// ---------------------------------------------------------------------------
