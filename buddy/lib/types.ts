...
export type PreferenceOperation = { name: "set_preferred_work_hours" | "set_daily_workload_limit" | "protect_time_block" | "set_break_habits" | "remove_preference" | "list_current_preferences"; arguments: Record<string, unknown> };
