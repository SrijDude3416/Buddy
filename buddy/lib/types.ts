...
export type PreferenceOperation = { name: "set_preferred_work_hours" | "set_daily_workload_limit" | "protect_time_block" | "set_break_habits" | "set_task_spacing" | "set_urgency_emphasis" | "set_minimum_gap" | "set_meal_window" | "set_commitment" | "add_task" | "remove_task" | "remove_preference" | "list_current_preferences"; arguments: Record<string, unknown> };
